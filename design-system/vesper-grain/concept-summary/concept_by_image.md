...
The underlying grid is a 12-column system with a consistent ~19px gutter. This gutter is narrow relative to section width, which reinforces a tight, editorial feel rather than an open-air layout.
...
The dominant background register is **dark near-black**. The interface does not use alternating light/dark backgrounds between sections — it maintains consistent darkness throughout.
...
- **Display/H1:** Condensed uppercase, ~85.5px, weight 400 — used as graphic element in hero and manifesto sections
- **H3/H4/Labels:** 14.256px, uppercase, weight 300–400 — used for product names, section labels
- **Body:** 19.008px, weight 400, line-height 28.512px — generous leading for readability
- **Nav/Links:** 14.256px, weight 300 — minimal, quiet
