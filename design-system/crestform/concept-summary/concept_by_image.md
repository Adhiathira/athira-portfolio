...
The type system uses **Clash Display** for all headings and structural text — a bold, geometric display typeface with distinctive wide letterforms — paired with **EB Garamond** for body text, providing humanist serif warmth against the geometric heading contrast. All typographic variation is achieved through:

- Weight: 400 (body) vs 600–700 (headings)
- Scale: small nav → 16px body → 206px h1 → 384px h2
