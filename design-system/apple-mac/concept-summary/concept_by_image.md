...
`★ Insight ─────────────────────────────────────`
Apple deliberately avoids hero-as-spectacle: by placing a bare `h1` on a white/gray field with no competing imagery, the heading itself becomes the visual event. This is only possible when the brand mark carries enough recognition that a single word ("Mac") needs no supporting context.
`─────────────────────────────────────────────────`
