...
- **Scale hierarchy over weight hierarchy**: headings and body use the same weight family (SF Pro); the 80px→17px jump does the hierarchical work, not bold/regular contrast
