...
The motion system for lacuna-grade is built on a **single organizing principle**: weight before speed.
...
Nothing snaps. Everything arrives. And when it has arrived, it is simply there — occupying the frame with the same indifference the amber field occupies the viewport.
